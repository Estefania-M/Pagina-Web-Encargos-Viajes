...
with open('../templates/template.html','r', encoding="utf-8") as template:
    file = template.read()
    print(file.format('Agregar Encargos','','','class="active"','','',
    """
    <div class="info">
    <div class="container">
      <br>
      <h1 class="jumbotron-heading"><br>Rellene los datos para agregar un encargo:</h1>
    </div>

    <div class="container">
      <form id="formulario"  action="save_encargo.py" method="POST" enctype="multipart/form-data">
        <div class="form-group">
          <label for="descripcion">Ingrese una descripción de su encargo:</label>
          <input type="text" size="100" class="form-control" id="descripcion" placeholder="descripción ..." name="descripcion">
        </div>
        <hr>

        <div class="row">
          <div class="form-group col-lg-6">
            <label for="espacio-solicitado">Seleccione el espacio a solicitar:</label>
          ...
          <div class="form-group col-lg-6">
            <label for="kilos-solicitados">Seleccione los kilos a solicitar:</label>
        ...
        <!--Si el usuario ingresa un archivo se añade el segundo input para el 2do archivo, lo mismo para el 3ro.-->
        <div class="form-group col-lg-4">
          <label for="foto-encargo-1">Suba fotos de su encargo:</label>
          <input type="file" class="form-control" id="foto-encargo-1" name="foto-encargo-1">
          <input type='file' class='form-control' id='foto-encargo-2' name='foto-encargo-2'>
          <input type='file' class='form-control' id='foto-encargo-3' name='foto-encargo-3'>
        </div>  
        <br>
        ...
        <br>
        <button type="submit" class="btn btn-primary">Confirmar Encargo</button>
          <hr>
      </form>
